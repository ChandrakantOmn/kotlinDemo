...
object ParseNumberFromString : Solution<Int>() {
    override var className: String = "ParseNumberFromString"
    override var result: Int = 0

    override fun solution() {
       // result = parseString("   -42")
        result = parseString("how are + you 143 -with words")
        printResult()
    }
